...
Part of the goals associated with the FMathL language were realized through the project A modeling system for mathematics (MoSMath), supported from 2008-2011 by a grant of the Austrian Science Foundation FWF under contract number [P20631](http://www.fwf.ac.at/de/abstracts/abstract.asp?L=E&PROJ=P20631).
